package com.soha.weather_app.weather.view.fragments.current
...
class HomeWeather : Fragment(R.layout.fragment_home_weather) {
    ...
    override fun onCreateView(
        ...
        locationViewModel.getTempDegree().observe(viewLifecycleOwner, Observer {
            binding.textCelcius.text = it.toString()
        })

       locationViewModel.getAddressData().observe(viewLifecycleOwner, Observer {
